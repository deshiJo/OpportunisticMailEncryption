    ...
    return {
	  ...
	  addUserCertificate(b64Certificate,name) { 
	      ...
	      addDomainCertificate(b64Certificate) {
		      ...
		      } catch (e) { console.log("error constructing cert domain object "); return false;}
		      ...
		      try {
			      ...
			      //certdb.addCert(c, "CPU,CPU,CPU", c.issuerName);
			      console.log("added");
		      } catch (e) {console.log("domain import error");console.log(e);return false;}
		      //	  }
		      //}
		      Services.obs.notifyObservers(null, "profile-after-change", null);
	  ...
	  checkDomainKnown(domain_name){
		//var found = certdb.findCertByNickname(null, domain_name)
		return true;
		if (found) {
			console.log("found cert domain \n:");
			console.log(found)
			return true;
		} else {
